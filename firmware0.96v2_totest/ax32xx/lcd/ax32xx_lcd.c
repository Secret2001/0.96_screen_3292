...
#define  R_LCD_RGBORD        LCDRGBORD
	...
	#define  LCD_SPI_CS_CH     GPIO_PF	//GPIO_PD
	#define  LCD_SPI_CS_PIN    GPIO_PIN4//GPIO_PIN5
	
	#define  LCD_SPI_CLK_CH    GPIO_PF	//GPIO_PD
	#define  LCD_SPI_CLK_PIN   GPIO_PIN1//GPIO_PIN6
	
	#define  LCD_SPI_DAT_CH    GPIO_PF	//GPIO_PD
	#define  LCD_SPI_DAT_PIN   GPIO_PIN3//GPIO_PIN7
